...
export const dummyTestimonialData = [
    {
        ...
        name: 'Ali Raza',
        title: 'Digital Marketing Specialist, Lahore Media House',
        content: 'ContentAI has made my workflow incredibly smooth. I can generate high-quality content in minutes, and it has boosted our campaign performance significantly.',
        rating: 5,
    },
    {
        image: assets.profile_img_1,
        name: 'Fatima Khan',
        title: 'Content Strategist, Karachi Creative Studio',
        content: 'This tool has saved me so much time. The AI-generated drafts are so accurate that I only need minor edits. Highly recommended for content teams.',
        rating: 4,
    },
    {
        image: assets.profile_img_1,
        name: 'Omar Al Mansoori',
        title: 'Brand Manager, Dubai Vision Agency',
        content: 'ContentAI has transformed how our team produces content. The efficiency and quality are unmatched, especially for fast-paced marketing environments in the UAE.',
        rating: 5,
    },
    {
        image: assets.profile_img_1,
        name: 'Sara Ahmed',
        title: 'Social Media Manager, Islamabad Digital Lab',
        content: 'Amazing tool! The AI suggestions are always on point, and it helps me maintain a consistent posting schedule without stress.',
        rating: 4,
    },
    {
        image: assets.profile_img_1,
        name: 'Mohammad Farooq',
        title: 'E-commerce Manager, Dubai Tech Mart',
        content: 'From product descriptions to ads, ContentAI does it all. It has increased our productivity and improved content clarity across all platforms.',
        rating: 5,
    },
];
