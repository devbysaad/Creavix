...
const GenerateImages = () => {
    ...
    const handleGenerate = () => {
        setIsLoading(true);
        setTimeout(() => {
            setImageUrl('https://via.placeholder.com/800x600/000000/FFFFFF?text=Generated+Image');
            setIsLoading(false);
        }, 2000);
    };
            ...
            <div className="max-w-7xl mx-auto h-full flex flex-col">
                ...
                <div className='flex flex-col lg:flex-row gap-8 flex-1 min-h-0'>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            <option className='bg-white'>Cinematic</option>
                                            <option className='bg-white'>Digital Art</option>
                                            <option className='bg-white'>Watercolor</option>
                                            <option className='bg-white'>Photorealistic</option>
                                            <option className='bg-white'>Anime</option>
                                        </select>
                    ...
                    <div className='w-full lg:w-2/3 flex-1 min-h-[500px] lg:min-h-0'>
                        <div className="h-full bg-white border-4 border-black rounded-none p-2 shadow-[8px_8px_0_0_#000000] relative overflow-hidden group">
                            {imageUrl ? (
